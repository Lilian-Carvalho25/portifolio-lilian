                        ...
                        <div className="education">
                            <div className="experiences">
                                ...
                                <div className="timeline-information">
                                    ...
                                    <p>Graduação na faculdade IMPACTA que forma profissionais aptos a projetar, analisar, desenvolver e implementar sistemas de informação.</p>
                                </div>
                            </div>
                            <div className="experiences">
                                <i className="icons-timeline">📚</i>
                                <div className="timeline-information">
                                    <span>2023</span>
                                    <h3>Desevolvedor Web Java</h3>
                                    <p>O Proa é um curso focado em empregabilidade, onde o jovem é preparado nos núcleos Técnico e Comportamental. O núcleo técnico desenvolve as competências técnicas do aluno em desenvolvimento Web Full Stack por meio de trabalho em grupo, vivências corporativas, projetos e atividades.</p>
                                </div>
                            </div>
                            <div className="experiences">
                                <i className="icons-timeline">📚</i>
                                <div className="timeline-information">
                                    ...
                                    <p>Programador web é um curso do Senac com o intuito de formar programadores com a capacidadade e a habilidade de estruturar em Front-end e desenvolver em Back-end, publicando aplicações web.Aqui eu tive o meu primeiro contato com programação e design, e aprendi muito.</p>
                                </div>
                            </div>
                        </div>
                    </div>
